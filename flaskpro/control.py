...
def second():
    ...
    return render_template('base.html', account= customers)
...
def form(): 
    if request.method=='POST':
        ...
        mycursor.execute(f'INSERT INTO account(name, password, age, address) VALUES("{_name}", "{_password}","{_email}", "{_address}" )')
        mydb.commit()
...
def logintrv():
    ...
    if request.method=='POST':
        ...
        mycursor.execute(f'SELECT * FROM account WHERE name = "{_name}" AND password = "{_password}"')
...
def trvl_d():
     ...
     if request.method == 'POST':
         _filenamee = request.form['filenamee']
         _country = request.form['country']
         _statee = request.form['statee']
         _town = request.form['town']
         _about_you = request.form['about_you']
         sql = (f'INSERT INTO delists (filenamee, county, statee, town, about_you) VALUES (%s, %s, %s, %s, %s)')
         val = (_filenamee, _country, _statee, _town, _about_you)
